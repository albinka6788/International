...
(function (za, O, l) {
    var N = function (h) {
        ...
        function vb(a, b, c, d, e, f) { if ("" !== b) for (var g = a.aiDisplay, d = Na(b, d, e, f), e = g.length - 1; 0 <= e; e--) b = a.aoData[g[e]]._aFilterData[c], d.test(b) || g.splice(e, 1); }
        ...
        function Hb(a, b) {
            ...
            for (var f,
                g = p.ext.type.order[c.sType +
                    "-pre"],
                j = 0,
                i = a.aoData.length; j < i; j++) if (c = a.aoData[j], c._aSortData || (c._aSortData = []), !c._aSortData[b] || d) f = d ? e[j] : A(a, j, b, "sort"), c._aSortData[b] = g ? g(f) : f;
        }
            ...
            Tb = function (a, b) {
                ...
                if (c.length && a.length) {
                    ...
                    if (d._details) {
                        ...
                        }), f.on("column-visibility.dt.DT_details", function (a, b) { if (e === b) for (var c, d = Z(b), f = 0, h = g.length; f < h; f++) c = g[f], c._details && c._details.children("td[colspan]").attr("colspan", d); }), f.on("destroy.dt.DT_details", function (a,
        ...
        r("row().child()", function (a, b) {
            ...
            if (!0 === a) this.child.show();
                ...
                if (h.isArray(a) ||
                    a instanceof h) for (var g = 0, j = a.length; g < j; g++) f(a[g], b);
                else f(a, b);
