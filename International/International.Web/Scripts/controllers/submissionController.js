            ...
            success: function (mvcResponse) {              
                ...
                if ($scope.currentprocess == $scope.enums.SubmissionProcess.CreateSubmission) {
                    ...
                    if ($scope.submissionModel.By_Berk_SI_FROM_Broker != null) {
                        var date = new Date($scope.submissionModel.By_Berk_SI_FROM_Broker);
                        console.log("Be" + date.getDate);
                        console.log("Be"+$scope.submissionModel.By_Berk_SI_FROM_Broker);
                        $scope.submissionModel.By_Berk_SI_FROM_Broker = utilities.unixToDateString($scope.submissionModel.By_Berk_SI_FROM_Broker);
                        console.log("Ae"+$scope.submissionModel.By_Berk_SI_FROM_Broker);
                        $scope.OnBy_Berk_SI_FROM_BrokerChange();                       
                    }
                    if ($scope.submissionModel.By_India_FROM_Berk_SI != null) {
                        $scope.submissionModel.By_India_FROM_Berk_SI = utilities.unixToDateString($scope.submissionModel.By_India_FROM_Berk_SI);
